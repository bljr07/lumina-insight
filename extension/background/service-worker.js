var LuminaBackground = (function (exports) {
  ...
  var ONNX_NODE = /*#__PURE__*/Object.freeze({
    __proto__: null,
    default: sharp
  });
  ...
  // Copyright (c) Microsoft Corporation. All rights reserved.
  // Licensed under the MIT License.
  let InferenceSession$2 = class InferenceSession {
      constructor(handler) {
  ...
  */
  ...
  var ortWeb_min = /*@__PURE__*/getDefaultExportFromCjs(ortWeb_minExports);

  var ONNX_WEB = /*#__PURE__*/_mergeNamespaces({
    __proto__: null,
    default: ortWeb_min
  }, [ortWeb_minExports]);
  ...
  const __dirname$1 = RUNNING_LOCALLY
      ? sharp.dirname(sharp.dirname(sharp.fileURLToPath((_documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === 'SCRIPT' && _documentCurrentScript.src || new URL('service-worker.js', document.baseURI).href))))
      : './';
  ...
  if (BROWSER_ENV) ; else if (sharp) ; else {
