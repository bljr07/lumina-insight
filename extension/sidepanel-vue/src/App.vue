<template>
  <div class="space-y-6 pb-6 p-4 text-ui-text min-h-screen font-sans antialiased overflow-x-hidden">
      <!-- Header -->
...
const fetchDashboardData = async () => {
    try {
        ...
        if (skillRes.ok) {
            ...
            await nextTick(); // Wait for DOM to render before drawing canvas
            renderRadarChart();
        }
    } catch (err) {
